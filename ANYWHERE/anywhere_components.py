...
from ANYWHERE.Helper.poles import find_poles, look_for_duplicates
...
def anywhere_selector(problem, individuals):
    ...
    for individual in new_population:
        ...
        distribution_list.append(correct_poles)
        ...
        temp_individual.correct_pole = correct_poles
...
def anywhere2_selector(problem, individuals):
    ...
    print ">> ", len([x for x in individuals if x.fitness.fitness is not None])
